...
<?php if ($comments) : ?>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<!-- <p class="nocomments"><?php _e('Comments are closed.','wp-andreas225'); ?></p> -->
...
<?php if ('open' == $post->comment_status) : ?>
    ...
    <h3 id="respond"><?php _e('Leave a Reply','wp-andreas225'); ?></h3>
    ...
    <?php else : ?>
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Submit Comment','wp-andreas225'); ?>" /></p>

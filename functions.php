...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Search'), 'widget_andreas09_search');
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('RSS Subscribe'), 'widget_andreas09_subscribe');	 
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Meta'), 'widget_andreas09_meta');
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Recent Posts'), 'widget_andreas09_recent_entries');

...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date(__('F jS, Y','andreas09')) ?> <?php _e('at','andreas09'); ?> <?php comment_time() ?></a> <?php edit_comment_link('Edit','',''); ?></small>
...
<p><?php _e('Logged in as','andreas09'); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account','andreas09'); ?>"><?php _e('Logout &raquo;','andreas09'); ?></a></p>
